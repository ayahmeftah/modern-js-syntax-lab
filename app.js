...
console.log(`Exercise 2: first: ${firstIngredient}, second: ${secondIngredient}`)
...
console.log(`Exercise 3: make: ${make}, model: ${model}`)
...
console.log("orginial object: ", anotherCar)
console.log("new object: ", myCar)
...
//
// Your code here:
function defaultParams(noun = "cat", adjective="orange"){
...
// Your code here:
const taste = pizza === 'tasty' ? 'yum' : 'yuck'
...
console.log("Exercise 10.1: ", lang)
